          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <button
                  onClick={() => handleCopy(COMPANY.contact.adminEmail, 'Admin')}
                  className="w-full text-left p-3 bg-white/10 rounded-xl hover:bg-white/20 transition flex items-center justify-between group"
                >
                  <div>
                    <div className="font-bold">admin@aadiyaliquidtools.com</div>
                    <div className="text-sm opacity-80">Admin Enquiries</div>
                  </div>
                  <Copy className="w-4 h-4 opacity-0 group-hover:opacity-100" />
                </button>
                <button
                  onClick={() => handleCopy(COMPANY.contact.salesEmail, 'Sales')}
                  className="w-full text-left p-3 bg-white/10 rounded-xl hover:bg-white/20 transition flex items-center justify-between group"
                >
                  <div>
                    <div className="font-bold">sales@aadiyaliquidtools.com</div>
                    <div className="text-sm opacity-80">Sales Enquiries</div>
                  </div>
                  <Copy className="w-4 h-4 opacity-0 group-hover:opacity-100" />
                </button>
                <button
                  onClick={() => handleCopy(COMPANY.contact.infoEmail, 'General')}
                  className="w-full text-left p-3 bg-white/10 rounded-xl hover:bg-white/20 transition flex items-center justify-between group"
                >
                  <div>
                    <div className="font-bold">info@aadiyaliquidtools.com</div>
