...
const Hero = () => {
  ...
  // Carousel slides - Updated with APAR-style content
  const slides = [
    {
      id: 1,
      title: "Premium Industrial Lubricants",
      description: "Authorized dealer of high-performance lubricants for automotive and industrial applications.",
      image: "🏭",
    ...
    },
    {
      ...
      description: "Quality assured products meeting international standards and industry approvals.",
      image: "🏆",
  ...
  // Feature cards - Updated with APAR-style stats
  const features = [
    { icon: <Shield className="w-8 h-8" />, title: "Trusted Quality", desc: "ISO Certified" },
    { icon: <Award className="w-8 h-8" />, title: "Authorized Dealer", desc: "Premium Products" },
    ...
    <section id="home" className="relative min-h-screen overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 pt-24 md:pt-32">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            {/* Trust Badge - Updated with APAR-style "We Are" message */}
            <motion.div
            ...
            >
              <span className="bg-gradient-to-r from-amber-300 to-orange-300 bg-clip-text text-transparent">ADITYA</span>
            ...
            >
              <span className="text-gray-300">Authorized Dealer of </span>
              <Typewriter
                words={[
                  'Premium Lubricants', 
        ...
        {/* Animated Stats - Updated with APAR-style stats */}
        <motion.div
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { icon: <Globe className="w-6 h-6" />, value: `${counter.cities}+`, label: 'Cities Covered', color: 'text-amber-400' },
              { icon: <Users className="w-6 h-6" />, value: `${counter.clients}+`, label: 'Industries Served', color: 'text-orange-400' },
              { icon: <TrendingUp className="w-6 h-6" />, value: `${counter.products}+`, label: 'Product Range', color: 'text-green-400' },
              { icon: <Truck className="w-6 h-6" />, value: `${counter.liters}K+`, label: 'Litres Supplied', color: 'text-blue-400' },
            ].map((stat, index) => (
