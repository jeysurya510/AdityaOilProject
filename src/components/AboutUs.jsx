...
const AboutUs = () => {
  ...
  const milestones = [
    { year: "2025", event: "Company Incorporation", icon: "🚀", description: `${COMPANY.shortName} officially registered as ${COMPANY.entityType}` },
    { year: "2025", event: "Quality Certification", icon: "🏆", description: "Achieved quality certification standards" },
    ...
    <section id="about" className="py-20 bg-gradient-to-b from-white via-gray-50 to-white">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            Trusted <span className="bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent">Lubricant Solutions</span>
          </motion.h2>
          ...
          >
            ...
            reliable service and industry expertise.
          </motion.p>
        </div>
              ...
              >
                <div>
                  ...
                  <div className="space-y-4 text-gray-700 leading-relaxed">
                    <p>
                      Aditya Liquidtools is an authorized dealer of premium industrial lubricants, 
                      supplying high-quality products from trusted brands. We ensure reliable products, 
                      timely delivery, and excellent customer support for industrial and commercial applications.
                    </p>
                    <p>
                      Our state-of-the-art supply chain network ensures consistent product availability 
                      and quality assurance across all industrial sectors.
                    </p>
                    <p>
                      With a focus on quality, reliability, and customer satisfaction, we are rapidly 
